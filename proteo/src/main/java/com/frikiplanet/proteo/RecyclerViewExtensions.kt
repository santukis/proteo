...
fun RecyclerView.setupOffsetScrollListener() {
    addOnScrollListener(object : RecyclerView.OnScrollListener() {
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            val horizontalOffsetFactor = (recyclerView.computeHorizontalScrollOffset() % measuredWidth) / measuredWidth.toFloat()
            val verticalOffsetFactor = (recyclerView.computeVerticalScrollOffset() % measuredHeight) / measuredHeight.toFloat()
